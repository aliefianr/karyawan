                ...
                <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="modal-slideup" aria-hidden="true">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default bg-gray-light">
                            <h3 class="block-title">Data <small class="text-primary font-w600">Jabatan</small></h3>
                            <button type="button" class="btn-block-option text-black ml-1" onclick="location.href='{{ url('/jabatan/tambah/') }}'">
                            ...
                            <table class="table table-bordered table-hover table-vcenter js-dataTable-full-pagination">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><small>ID Jabatan</small></th>
                                        <th class="text-center"><small>Nama Jabatan</small></th>
                                        <th class="text-center"><small>Kode Jabatan</small></th>
                                        <th class="text-center"><small>Gaji Jabatan</small></th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $p->jabatan_id }}</td>
                                        <td class="">{{ $p->jabatan_nama }}</td>
                                        <td class="text-center">{{ $p->jabatan_kode }}</td>
                                        <td class="">Rp.{{ $p->jabatan_gaji}},-</td>
                                        <td class="text-center">
                                                <button type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" 
                                                onclick="location.href='/jabatan/edit/{{ $p->jabatan_id }}'">
                                                    <i class="fa fa-pencil"></i>
                                                </button>
                                                <button type="button" class="btn btn-sm btn-secondary" data-toggle="tooltip" 
                                                onclick="deleteConfirm('/jabatan/hapus/{{ $p->jabatan_id }}')">
