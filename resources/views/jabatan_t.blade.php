                    ...
                    <div class="col-4">
                        <div class="block block-themed block-mode-loading-refresh">
                            ...
                            <div class="block-header bg-gray-light">
                                <h3 class="block-title text-black font-w600">Tambah Data Jabatan</h3>
                            ...
                            <div class="row block-content justify-content-center block-content-full">
                                <form class="js-validation-signin px-30" nama="myForm" action="/jabatan/store" enctype="multipart/form-data" method="post" >
                                {{csrf_field()}}    
                                <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material">
                                                <input type="text" class="form-control" id="j_nama" name="j_nama">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material">
                                                <input type="text" class="form-control" id="j_kode" name="j_kode">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material">
                                                <input type="number" class="form-control" id="j_gaji" name="j_gaji">
                                                <label for="j_gaji">Gaji Jabatan</label>
                                            </div>
                                        </div>
                                    </div>
