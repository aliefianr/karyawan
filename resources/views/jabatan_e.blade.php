...
<body>
  ...
  <header id="page-header">
                    ...
                    <div class="col-4">
                        <div class="block block-themed block-mode-loading-refresh">
                            ...
                            <div class="block-header bg-gray-light">
                                <h3 class="block-title text-black font-w600">Edit Data Jabatan</h3>
                                <div class="block-options">
                                    <button type="button" class="btn-block-option text-black" data-toggle="block-option" data-action="content_toggle"></button>
                                    <button type="button" class="btn-block-option text-black" onclick="location.href='{{ url('/jabatan/') }}'">
                            ...
                            <form class="js-validation-signin px-30" nama="myForm" action="/jabatan/update" enctype="multipart/form-data" method="post" >
                                {{csrf_field()}}    
                                <input type="hidden" name="id" value="{{ $p->jabatan_id }}"> 
                                <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material">
                                                <input type="text" class="form-control" id="j_nama" name="j_nama" value="{{ $p->jabatan_nama }}">
                                                <label for="j_nama">Nama Jabatan</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material">
                                                <input type="text" class="form-control" id="j_kode" name="j_kode" value="{{ $p->jabatan_kode }}">
                                                <label for="j_kode">Kode Jabatan</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material">
                                                <input type="text" class="form-control" id="j_gaji" name="j_gaji" value="{{ $p->jabatan_gaji }}">
                                                <label for="j_gaji">Gaji</label>
                                            </div>
                                        </div>
                                    </div>
    ...
    <!-- Page JS Code -->
    <script src="{{ url('/assets/') }}/js/pages/op_a_add_j.js"></script>
    <script>
