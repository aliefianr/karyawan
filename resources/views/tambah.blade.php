                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-material">
                                                <select class="form-control" id="k_jabatan" name="k_jabatan">
                                                    <option value="">Pilih..</option>
                                                    <option value="1201">Head Manager - Rp.20.000.000,-</option>
                                                    <option value="1202">Designer - Rp.10.000.000,-</option>
                                                    <option value="1203">Android Developer - Rp.10.000.000,-</option>
                                                    <option value="1204">Consultant - Rp.15.000.000,-</option>
                                                </select>
