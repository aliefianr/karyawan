            ...
            <div class="js-wizard-simple block">
                ...
                <form action="be_forms_wizard.php" method="post">
                    ...
                    <div class="block-content block-content-sm">
                        <div class="progress" data-wizard="progress">
                            <div class="progress-bar progress-bar-striped progress-bar-animated bg-primary" role="progressbar" style="width: 30%; height: 5px;" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
